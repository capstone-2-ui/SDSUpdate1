<?php
/**
 * PHPMailer - PHP email creation and transfer class.
 * SMTP RFC 821, 2821, 5321, 6531, 6532, 6533, 4954, 4408, 4616, 4952, 5068.
 *
...
, appropriate for browser output
     ...
     * Implements RFC 821: DATA <CRLF> ... <CRLF>.<CRLF> .
     *
     ...
     * Implements RFC 821: HELO <domain> <CRLF>
     * and RFC 2821 EHLO.
     *
     ...
     * Implements RFC 821: MAIL FROM:<reverse-path> <CRLF> and
     ...
     * Implements from RFC 821: RCPT TO:<forward-path> <CRLF> .
     *
     ...
     * Implements RFC 821: SAML FROM:<reverse-path> <CRLF> .
     *
