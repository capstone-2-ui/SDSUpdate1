...
function DashboardPage({ user }) {
  ...
  const DASHBOARD_API = "http://192.168.2.110/SDSUpdate1-main/backend/Dashboard.php";
  const INCIDENTS_API = "http://192.168.2.110/SDSUpdate1-main/backend/Incident.php";
